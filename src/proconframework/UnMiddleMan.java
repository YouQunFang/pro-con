 ...
 * @author youqunfang
 */
public class UnMiddleMan implements Runnable {

    private UnboundedBuffer takebuffer;
    private UnboundedBuffer putbuffer;

    public UnMiddleMan(UnboundedBuffer takebuffer, UnboundedBuffer putbuffer) {
